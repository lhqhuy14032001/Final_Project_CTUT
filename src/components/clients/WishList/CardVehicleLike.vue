<template>
  <div
    class="vehicle-liked grid grid-cols-4 border border-gray-200 p-4 rounded-lg my-3"
    v-if="props.wishListItem"
  >
    <div class="car-info col-span-3 flex gap-5">
      <div class="car-img w-60 col-span-1">
        <img
          src="https://n1-pstg.mioto.vn/cho_thue_xe_o_to_tu_lai_thue_xe_du_lich_cantho/vinfast_vf_e34_2022/p/g/2022/09/16/13/OpM2VPkYiSjmzgiRnple8A.jpg"
          alt="car img vehicle"
      ...
      <div class="col-span-2 text-left">
        <p
          class="gearbox text-xs w-fit bg-slate-200 px-3 py-1 mb-3 rounded-full"
        >
          {{ gearbox }}
        </p>
        <p class="text-lg font-bold text-black">{{ carname }}</p>
        <div class="flex gap-5">
          <div class="star flex gap-1 items-center">
    ...
    <div class="price-hire col-span-1 border-l-2 pl-4">
      <div class="user-avatar w-10 mx-auto">
        <img
      ...
      <div class="price mt-3 text-left">
        <span class="text-black text-xl">{{ price }}K</span>
        <span class="text-gray-500">/ngày</span>
      </div>
      <div
        class="my-3 p-4 mx-auto bg-primary text-white font-semibold rounded-lg cursor-pointer hover:shadow-lg"
      >
        Bỏ thích
      </div>
  ...
  <div class="Empty-wish-list w-[50%] mx-auto" v-else>
    <img
      ...
      class="w-full"
    />
    <p class="text-2xl text-gray-500">Không có xe yêu thích</p>
  </div>
</template>
...
let gearbox = "Số tự động";
let carname = "vinfast vf e34 2022";
